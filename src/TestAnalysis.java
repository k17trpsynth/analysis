...
public class TestAnalysis {
    ...
    public static void main(String[] args) {
        ...
        input.setElement(1, "steel_wire", "tension", 1, 2, 0, 0);
        input.setElement(2, "steel_wire", "tension", 2, 3, 0, 0);
        input.setElement(3, "steel_wire", "tension", 3, 4, 0, 0);
        input.setElement(4, "steel_wire", "tension", 4, 1, 0, 0);
        input.setElement(5, "steel", "compression", 5, 1, 0, 0);
        input.setElement(6, "steel", "compression", 5, 2, 0, 0);
        input.setElement(7, "steel", "compression", 5, 3, 0, 0);
        input.setElement(8, "steel", "compression", 5, 4, 0, 0);
